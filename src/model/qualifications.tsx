...
export const FEATURED_QUALIFICATIONS = [
  'Storm and Water Damage Operation',
  'Land Search Team Member',
  'Chainsaw Operator (Cross-Cut & Limb)',
  'Chainsaw Operator (Tree Felling)',
...
/**
 * For some qualifications it's redundant to shown them.
 */
export const SUPPRESSED_QUALIFICATIONS = {
...
export const QUALIFICATION_ABBREVIATIONS = {
